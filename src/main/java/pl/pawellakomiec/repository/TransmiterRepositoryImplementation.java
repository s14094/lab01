...
public class TransmiterRepositoryImplementation implements TransmiterRepository{
    ...
    public TransmiterRepositoryImplementation(Connection connection) throws SQLException {
    ...
    public void setConnection(Connection connection) throws SQLException{
        this.connection = connection;
        addTransmiterStmt = connection.prepareStatement("INSERT INTO Transiter (name) VALUES (?)");
...
//
//        PreparedStatement preparedStatement = connection.prepareStatement("SELECT * FROM Transmiter WHERE id = ?");
//        ResultSet results = preparedStatement.executeQuery();
//        return new Transmiter(results.getInt("id"), results.getString("name"));
    }
